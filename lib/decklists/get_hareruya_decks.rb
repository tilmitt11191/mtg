...
class DeckID
	...
	def create_deckfile(create_mode)
		deck = Deck.new(@name, "hareruya", "http://www.hareruyamtg.com/jp/k/" + @id + "/")

		#create deck.cards
		deck.create_cardlist(create_mode)
...
##############################################
decks = []
create_mode = "except_price"





decks.each do |deck| deck.create_deckfile(create_mode) end
##############################################
...
id = "kD08240S"
name = "WUB_Con_"+id.to_s
decks.push DeckID.new(id,name)

id = "kD08241S"
name = "BG_Con_"+id.to_s
decks.push DeckID.new(id,name)

id = "kD08242S"
name = "RG_Goggles_"+id.to_s
decks.push DeckID.new(id,name)
