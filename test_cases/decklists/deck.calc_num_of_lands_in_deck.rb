...
begin
	...
	decknames.each do |deckname|
		...
		num_of_lands = deck.calc_num_of_lands_in_deck

		if num_of_lands == 25 then
			puts "[ok]deck.calc_num_of_lands_in_deck[" + deckname.to_s + ".csv].number of land cards are " + num_of_lands.to_s
		else
			puts "[ng]deck.calc_num_of_lands_in_deck[" + deckname.to_s + ".csv].number of land cards are " + num_of_lands.to_s
		end	
	end
	...
	decknames.each do |deckname|
		...
		if num_of_lands == 26 then
			...
			puts "[ng]deck.calc_calc_num_of_lands_in_deck[" + deckname.to_s + ".csv].number of land cards are " + num_of_lands.to_s
		end	
	end
